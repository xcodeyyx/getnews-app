...
const Login = () => {
  ...
  return (
    <div className="w-full flex justify-center items-center min-h-screen bg-gray-900 md:w-[400px] lg:w-[400px] lg:ml-170">
      <div className="w-full max-w-md p-8 space-y-8 bg-gray-900 rounded-xl shadow-lg">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl text-white font-display">Welcome To GetNews</h2>
          <p className="mt-2 text-white font-dekrip">Sign in to your chat account</p>
        </div>
